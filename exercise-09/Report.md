...
## Executive Summary
This exercise investigates nonlinear chaotic dynamics using two classical systems: Lorenz (`Exercise9a.m`) and Rossler (`Exercise9b.m`). For both models, phase portraits and 3D attractors are analyzed, and sensitivity to initial conditions is tested by running two trajectories with nearly identical initial states.
...
## Conclusion
Exercise 09 successfully demonstrates chaotic dynamics in two classical models.
